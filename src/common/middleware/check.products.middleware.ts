...
export const checkProductsMiddleware = async (
	...
	const idNotExist = await productsService.checkIdExists(
		products,
		foundProducts,
	);
	...
	const notAvailable = await productsService.checkAvailability(
		products,
		foundProducts,
	);
